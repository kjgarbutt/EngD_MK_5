 ...
 *
 */
public class MK_5WithUI extends GUIState	{
     ...
     * Default constructor
     */
    protected MK_5WithUI(SimState state)	{
            super(state);
        }
    ...
    private void setupPortrayals()
    {
        ...
        public static void main(String[] args)	{
        	MK_5WithUI simple = new MK_5WithUI(
        			new sim.MK_5(System.currentTimeMillis()));
        ...
        public void start()	{
            ...
            agentPortrayal.setPortrayalForAll(new GeomPortrayal(Color.PINK, 125, true));
            
            ngoAgentPortrayal.setField(world.ngoagents);
            ngoAgentPortrayal.setPortrayalForAll(new GeomPortrayal(Color.PINK, 125, true));
            ...
            limactagentPortrayal.setPortrayalForAll(new GeomPortrayal(Color.PINK, 125, true));
        ...
        public void init(Controller c)
        {
            ...
            displayFrame.setTitle("EngD ABM Model MK_5");
